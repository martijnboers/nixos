let
  glassdoor = builtins.replaceStrings {"\n" = "";} builtins.readFile ../nixos/keys/glassdoor.pub;
  laptop = builtins.replaceStrings {"\n" = "";} builtins.readFile ../nixos/keys/laptop.pub;
  hadouken = builtins.replaceStrings {"\n" = "";} builtins.readFile ../nixos/keys/hadouken.pub;
